...
// MARK: - Models (Declared before SyncQueue to avoid forward reference issues)

/// Core Data entity for sync operations
@objc(SyncOperationRecord)
public class SyncOperationRecordEntity: NSManagedObject {
...
public class SyncQueue {
    ...
    public func enqueue(
        ...
        backgroundContext.perform {
            let operation = NSEntityDescription.insertNewObject(forEntityName: "SyncOperationEntity", into: backgroundContext) as! SyncOperationRecordEntity
    ...
    public func getPendingOperations(completion: @escaping ([SyncOperationRecordEntity]) -> Void) {
        let backgroundContext = container.newBackgroundContext()
        backgroundContext.perform {
            let fetchRequest = NSFetchRequest<SyncOperationRecordEntity>(entityName: "SyncOperationEntity")
